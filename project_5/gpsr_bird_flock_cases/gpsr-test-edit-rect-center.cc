...
*/
  ...
  mobility.SetMobilityModel ("ns3::RandomDirection2dMobilityModel", "Bounds", RectangleValue (Rectangle (0.0, 1200.0, 0.0, 500.0)));
  ...
  positionAllocS->Add(Vector(600.0, 250.0, 0.0));
